...
Za utvrđivanje interakcijskog učinka hipertenzije i srčanih bolesti na BMI možemo koristiti višestruku linearnu regresiju ako podaci zadovoljavaju sve njene uvjete. Regresori moraju biti linearni, to je zadovoljeno jer oba regresora poprimaju vrijednosti 0 ili 1. Reakcija mora biti kontinuirana  
...
input <- stroke_data[, c("bmi" , "hypertension")]

plot(x = input$hypertension, y = input$bmi,)

input <- stroke_data[, c("bmi" , "heart_disease")]

plot(x = input$heart_disease, y = input$bmi,)
